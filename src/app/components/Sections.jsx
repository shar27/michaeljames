...
function Sections() {
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row">
      {/* image 1 */}
    <div className="card bg-base-300 rounded-box grid h-64 lg:h-32 flex-grow place-items-center">
    <div
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold">Deal Selling
      Launch Pad</h1>
      <p className="mb-5">
    ...
    <div className="card bg-base-300 rounded-box grid h-0 lg:h-32 flex-grow place-items-center mt-96 lg:mt-0 "><div
  className="hero min-h-screen"
  style={{
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold">Property Investment
      Launch Pad</h1>
      <p className="mb-5">
